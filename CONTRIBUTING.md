...
If you want to learn more about this project, read the [wiki](https://github.com/Chia-Network/lotus-blockchain/wiki), or check out the [green paper](https://www.lotus.net/assets/LotusGreenPaper.pdf).
