...
import { useGetBlockQuery, useGetBlockRecordQuery } from '@lotus/api-react';
...
export default function Block() {
  ...
  const poolReward = mojoToLotus(calculatePoolReward(blockRecord.height));
  const baseFarmerReward = mojoToLotus(
    calculateBaseFarmerReward(blockRecord.height),
  );

  const lotusFees =
    blockRecord.fees !== undefined ? mojoToLotus(blockRecord.fees) : '';
