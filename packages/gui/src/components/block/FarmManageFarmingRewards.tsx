...
import { Button, Flex, Form, TextField, Loading } from '@lotus/core';
import { useSetRewardTargetsMutation, useGetRewardTargetsQuery } from '@lotus/api-react';
import {
  Alert,
  Dialog,
  DialogActions,
              ...
              <>
                ...
                <Typography variant="body2" color="textSecondary">
                  <Trans>
                    ...
                    0.25LCH reward for pooling plots.
                  </Trans>
                </Typography>
              </>
            )}
