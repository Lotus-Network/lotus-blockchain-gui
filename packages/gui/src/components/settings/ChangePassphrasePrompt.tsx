...
import { AlertDialog, Button, DialogActions, Flex, useOpenDialog, Suspender, useValidateChangePassphraseParams } from '@lotus/core';
import { useGetKeyringStatusQuery, useRemoveKeyringPassphraseMutation, useSetKeyringPassphraseMutation } from '@lotus/api-react';
      ...
      <DialogContent>
        ...
        {!!canSavePassphrase && (
          <Box display="flex" alignItems="center">
            ...
            />
            <Tooltip title={t`Your passphrase can be stored in your system's secure credential store. Lotus will be able to access your keys without prompting for your passphrase.`}>
