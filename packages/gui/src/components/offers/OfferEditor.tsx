...
import { useCreateOfferForIdsMutation } from '@lotus/api-react';
...
import { lotusToMojo, catToMojo } from '@lotus/core';
...
function OfferEditor(props: OfferEditorProps) {
  ...
  async function onSubmit(formData: FormData) {
    ...
    let feeInMojos = lotusToMojo(formData.fee ?? 0);
