...
import { OfferTradeRecord, toBech32m } from '@lotus/api';
import {
  Button,
  Checkbox,
  Dialog,
...
enum HashgreenErrorCodes {
  ...
  MARKET_NOT_FOUND = 50029, // Pairing doesn't exist e.g. LCH/RandoCoin
...
const KeybaseTeamName = 'lotus_offers';
...
function OfferShareKeybaseDialog(props: OfferShareServiceDialogProps) {
  ...
  const teamName = testnet ? 'testlchoffersdev' : KeybaseTeamName;
