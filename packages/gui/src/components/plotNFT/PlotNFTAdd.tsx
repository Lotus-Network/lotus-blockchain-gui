...
import { useCreateNewPoolWalletMutation } from '@lotus/api-react';
import { ChevronRight as ChevronRightIcon } from '@mui/icons-material';
import { Flex, Suspender } from '@lotus/core';
  ...
  return (
    <>
      ...
      <PlotNFTSelectPool
        ...
        description={
          <Trans>
            Join a pool and get consistent LCH farming rewards. The average
