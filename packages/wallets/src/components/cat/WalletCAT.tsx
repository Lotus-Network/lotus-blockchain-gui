...
import { Flex, Loading, useOpenDialog } from '@lotus/core';
...
import { useSetCATNameMutation, useGetCatListQuery } from '@lotus/api-react';
import { Offers as OffersIcon } from '@lotus/icons';
