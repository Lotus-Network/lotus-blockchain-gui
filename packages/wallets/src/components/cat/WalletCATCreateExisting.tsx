...
import { AlertDialog, Fee, Back, ButtonLoading, Card, Flex, Form, TextField } from '@lotus/core';
import { Box, Grid } from '@mui/material';
import { useDispatch } from 'react-redux';
import { useForm } from 'react-hook-form';
import { useNavigate } from 'react-router';
import { create_cc_for_colour_action } from '../../../modules/message';
import { lotusToMojo } from '@lotus/core';
...
export default function WalletCATCreateExisting() {
  ...
  async function handleSubmit(values: CreateExistingCATWalletData) {
    try {
      ...
      const feeMojos = lotusToMojo(fee || '0');
      ...
      <Flex flexDirection="column" gap={3}>
        <Back variant="h5">
          {asteroid 
            ...
            : <Trans>Create Lotus Asset Token Wallet from Existing TAIL</Trans>}
