...
import { AlertDialog, Card, Flex, Loading, Dropzone, mojoToLotusLocaleString } from '@lotus/core';
import {
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojoToLotusLocaleString(props.balance)} TXCH
          </Typography>
        </Box>
      </Box>
    </Grid>
...
const CashoutCard = (props) => {
  ...
  function cashout() {
    ...
    if (puzzlehash.slice(0, 12) === 'lotus_addr://') {
