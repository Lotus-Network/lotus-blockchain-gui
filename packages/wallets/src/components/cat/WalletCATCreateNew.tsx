...
import { lotusToMojo, AlertDialog, Amount, Fee, Back, ButtonLoading, Card, Flex, Form } from '@lotus/core';
  ...
  async function handleSubmit(values: CreateCATWalletData) {
    try {
      ...
      */
      ...
      const amountMojos = lotusToMojo(amount || '0');
  ...
  return (
    <Form methods={methods} onSubmit={handleSubmit}>
      <Flex flexDirection="column" gap={3}>
        <Back variant="h5">
          <Trans>Create New Lotus Asset Token Wallet</Trans>
        </Back>
        <Card>
