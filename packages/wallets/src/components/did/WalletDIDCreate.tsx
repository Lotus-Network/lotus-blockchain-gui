...
import { Amount, Form, AlertDialog, Back, Card, Flex, ButtonLoading, lotusToMojo } from '@lotus/core';
import {
  Typography,
  Button,
  Box,
...
export default function WalletDIDCreate() {
  ...
  async function onSubmit(data) {
    try {
      ...
      const amount_val = lotusToMojo(data.amount);
      if (
        amount_val === '' ||
        Number(amount_val) === 0 ||
        !Number(amount_val) ||
          ...
          <Flex flexDirection="column" gap={3}>
            <Flex flexDirection="column" gap={1}>
              <Flex alignItems="center" gap={1}>
                ...
                <Tooltip title="The amount of Lotus you enter must correspond to an even amount of mojos. One additional mojo will be added to the total amount for security purposes.">
